...
export function FormularioDiagnostico() {
    ...
    return (
      <div className="ficha-form">
        ...
        <div className="recebido">
          <span className="etiqueta etiqueta--azul">Protocolo aberto</span>
  ...
  return (
    <form onSubmit={enviar} className="ficha-form" noValidate>
      <div className="ficha-form__cabeca">
      ...
      <div className="ficha-form__corpo">
        ...
        {passo === 1 && (
          <>
            ...
            <Campo rotulo="Instagram (opcional)">
              <input value={dados.instagram} onChange={definir("instagram")} placeholder="@suaempresa" />
            </Campo>
        ...
        <div className="form__acoes">
          {passo > 0 && (
            <button
              type="button"
              className="bt bt--linha bt--voltar"
          ...
          {passo < 2 ? (
            <button type="button" className="bt bt--claro" onClick={avancar}>
              Continuar
            </button>
          ) : (
            <button type="submit" className="bt bt--claro" disabled={enviando}>
