...
const CASOS = [
  {
    ...
    contexto:
      "Cronograma de conteúdo semanal, API de Conversões e os reels que performaram virando anúncio.",
    antes: "2,1×",
    depois: "6,2×",
  },
  {
    ...
    contexto: "Posicionamento refeito, vídeos com a equipe da clínica e primeiro contato em até 10 minutos.",
    antes: "R$ 84",
    depois: "R$ 31",
  },
  {
    ...
    contexto: "Conteúdo técnico no feed sustentando o Google Ads de intenção alta, com follow-up definido.",
    antes: "18/mês",
    depois: "61/mês",
  },
];
